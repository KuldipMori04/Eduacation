	...
	<div class="container" id="container" style="height: 150vh;">
		<div class="form-container sign-up-container">
			<form action="" method="POST">
				...
				<input class="input2" name="name" type="text" placeholder="Name" />
				<input class="input2" name="email" type="email" placeholder="Email" />
				<input class="input2" name="study" type="study" placeholder="Study" />
				<input class="input2" name="password" type="password" placeholder="Password" />
		...
		<div class="overlay-container">
			<div class="overlay">
				...
				<button class="ghost"  href="view.php" id="signIn" name="check">Check Form</button>
				</div>
